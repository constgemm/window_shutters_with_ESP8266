...
*
* Style Guidlines for the future: I use sublime text and
* https://packagecontrol.io/packages/SublimeAStyleFormatter
* for formatting.
* otherwise see: http://www.cs.umd.edu/~nelson/classes/resources/cstyleguide/
* for style guide.
*/
...
const char * ssid = "WiFi Name", password = "Password";
const int pin_up = 14, pin_down = 12;
// Set web server port number to 80
WiFiServer server(80);
// Variable to store the HTTP request
// Auxiliar variables to store the current output state
String output_up = "stop", output_down = "stop", header;
void setup()
{
